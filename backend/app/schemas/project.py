...
class ProjectCreate(BaseModel):
    ...
    default_scan_mode: Optional[str] = Field('custom', description="Default scan mode for git triggers: 'preset' (Quick Scan), 'custom' (Full Scan)")
    default_profile_mode: Optional[str] = Field('preset', description="Default profile mode for git triggers: 'preset' (기본 설정), 'custom' (고급 설정)")
